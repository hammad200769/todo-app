...
export const metadata: Metadata = {
  title: 'Privacy Policy - TweetStorm.ai',
  description:
    "Discover TweetStorm's commitment to safeguarding your data with our comprehensive privacy policy. We prioritize your security and adhere strictly to all relevant privacy laws and regulations, ensuring your information remains protected at all times.",
  alternates: {
    canonical: getAbsoluteUrl(URLS.privacyPolicy),
  },
};
  ...
  return (
    <>
      <div className='min-h-screen'>
        <GuestLayoutHeader />
        <main className='responsive-pad py-12 bg-soft-white mt-[2px] dark:bg-primary-dark-light'>
          <article className='mx-auto sm:max-w-2xl overflow-hidden sm:rounded-lg text-neutral-gray prose mt-4 dark:prose-invert dark:text-neutral-gray__dark'>
            ...
            <p>
              Your privacy is important to us. It is TweetStorm.ai&#39;s policy
            ...
            <p>This policy is effective as of 3 July 2021. </p>
            <p>Last updated: 3 July 2021 </p>
            ...
            <p>
              ...
              Estonia, and Germany, or where we or our partners, affiliates, and
            ...
            <p>
              ...
              processors&rdquo;). We, TweetStorm.ai, located at the address
