    ...
    <section id='pricing' className='pt-20'>
      <div>
        <div className='mx-auto max-content-w text-center'>
          <h1 className='text-5xl sm:text-6xl font-bold'>Pricing</h1>
      ...
      <div className='flow-root pb-[1px] mt-10'>
        ...
        <div className='mt-20 md:block hidden'>
          <div className='mx-auto max-content-w text-center'>
            <h2 className='text-3xl sm:text-5xl font-bold'>Comparison</h2>
            <p className='mt-3 text-2xl tracking-tight'>
              Compare features across plans and choose the best fit for you.
            </p>
          </div>
          <div className='max-w-7xl mx-auto'>
            <PlanTable plans={Object.values(PLANS)} />
          </div>
        </div>
