...
type GeneratedHandlesBlockProps = {
  content: string;
};

function GeneratedHandlesBlock({ content }: GeneratedHandlesBlockProps) {
  useEffect(() => {
    ...
    >
      <TweetWrapper>
        ...
        <div className='flex-c gap-3 p-4 border-t border-gray-200 dark:border-dark-mode-border'>
          <TweetGeneratedContentLink url='https://twitter.com/settings/screen_name'>
            Change handle
...
export default GeneratedHandlesBlock;
